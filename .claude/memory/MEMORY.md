...
- [Connect ONG remodel mobile](connect-ong-remodel-mobile.md) — **Bloco 21 quase pronto** (fase 6: hub antigo aposentado→shell, categorias canônicas mobile+API, shell adaptativo desktop/NavigationRail, EmptyState); resta signup Instagram, imagens nos cards, busca na home; **build windows bloqueado: Modo Desenvolvedor OFF**
