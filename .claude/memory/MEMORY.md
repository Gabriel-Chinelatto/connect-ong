...
- [Connect ONG roadmap](connect-ong-roadmap.md) — MASTER roadmap; **0-20 e 22-30 DONE** (todas as funções: Match→…→Mural/Ranking/Conquistas/Favoritos/Denúncia/PDF); **resta só o Bloco 21 (polimento visual MASTER FINISH)**; +seção **PÓS-ROADMAP (sessão 2026-07-02)**: chat estilo WhatsApp (visto/online/digitando/reações emoji), ROLE_ADMIN, soft-delete, Modo Feira (credenciais no login), sincronizar.bat 1-clique, banco populado
