...
- [Connect ONG roadmap](connect-ong-roadmap.md) — MASTER roadmap (blocos 0-30 + priority tiers); 0-12 done (Match→Notificações); Phase I complementos (Campanhas/Timeline/Perfil público/Mural) added; compress-near-deadline rule
...
- [Git workflow preferences](git-workflow-preferences.md) — commit/push only when asked, no Claude co-authorship
