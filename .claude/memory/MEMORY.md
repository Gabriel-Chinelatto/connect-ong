...
- [Connect ONG roadmap](connect-ong-roadmap.md) — MASTER roadmap (blocos 0-20 + priority tiers); 0-4 done (Match+Chat+Dashboard), Bloco 5 next; compress-near-deadline rule
