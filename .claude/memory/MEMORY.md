...
> **📷 Fotos reais nas 6 ONGs da feira** (ids 20/32/33/34/35/36): capas livres do Wikimedia, no banco LOCAL; `ATUALIZAR-BANCO` re-aplica sozinho. Originais em `interno/fotos-ongs/`. Produção (escola/Render) intocada.
...
> **Testes:** backend **191** · doador **101** · painel **52** (todos verdes em 24/08).
